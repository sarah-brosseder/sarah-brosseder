      ...
      <>
        <div className="bullets__container">
          ...
          <div id="bullets-title" className="bullets__title-container">
            <h1 className="bullets__headline">Hier findest Du eine Auswahl der Themen, die wir gemeinsam in Workshop-Form oder prozessual bearbeiten können. Sprich mich gerne an, wenn das was Du suchst noch nicht dabei ist.</h1>
